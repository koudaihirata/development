...
export default function IconBox({
    ...
    //==============================
    const openModal = () => {
        if (iconList.length < 9) {
            setModalToggle(true);
        } else {
            alert("準備中の持ち物をカバンに仕分けして下さい");
        }
    };
    ...
    useEffect(() => {
        ...
        iconList.forEach((icon) => {
            ...
            // onpointerdown イベントを設定し、どの iconId を動かしているかを記録
            newIcon.onpointerdown = (event) =>
                handlePointerDown(event as PointerEvent, newIcon, icon.id);
